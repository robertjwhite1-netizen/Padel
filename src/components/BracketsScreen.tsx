...
export default function BracketsScreen({
  ...
  return (
    <div className="flex-1 flex flex-col p-5 space-y-4">
      ...
      {!semiFinals ? (
        <div className="flex-1 flex flex-col items-center justify-center text-center py-12 px-4 bg-slate-950/40 border-2 border-dashed border-slate-800 rounded-3xl space-y-4">
          <div className="p-3 bg-emerald-500/10 rounded-full text-emerald-400">
            <Trophy className="w-8 h-8" />
          </div>
          <div>
            <h3 className="font-extrabold text-white text-base">Generate Playoffs (Semi-finals)</h3>
            <p className="text-xs text-slate-400 mt-2 max-w-xs leading-relaxed">
              Based on the current standings, the top 8 players will pair up to play the semi-finals:
            </p>
            <div className="bg-slate-900 border border-slate-800 text-[10.5px] p-2.5 rounded-xl text-left font-mono mt-3 text-slate-300 space-y-1">
          ...
          <button
            ...
            className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-sm px-6 py-3.5 rounded-xl shadow-lg transition-transform active:scale-95 cursor-pointer"
          >
        ...
        <div className="space-y-5 flex-1 overflow-y-auto max-h-[500px] pr-1">
          ...
          <div className="space-y-3">
            ...
            {/* SEMI 1 GRID CELL */}
            <div className="bg-slate-950/70 p-3.5 rounded-2xl border border-slate-850 space-y-3">
              <div className="flex items-center justify-between border-b border-slate-900 pb-2 select-none">
                <span className="font-extrabold text-[11px] text-teal-400 uppercase tracking-widest">
              ...
              <div className="grid grid-cols-11 gap-1 items-center">
                ...
                <div className="col-span-5 text-center space-y-1">
                  <select
                    className="w-full bg-slate-900 text-white text-xs font-bold border border-slate-800 rounded p-1"
                  ...
                  <span className="text-[9px] text-emerald-400 uppercase tracking-wider font-extrabold block">
                    Pair A
                  </span>
                </div>

                <div className="col-span-1 text-center font-bold text-slate-600 text-xs select-none">
                  vs
                </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 pt-1 select-none">
                <button
                  ...
                  className={`py-2 rounded-xl text-[10px] font-black uppercase tracking-wider text-center border transition-all cursor-pointer ${
            ...
            <div className="bg-slate-950/70 p-3.5 rounded-2xl border border-slate-850 space-y-3">
              ...
              <div className="grid grid-cols-11 gap-1 items-center">
                {/* Team 1 (Rank 2 & 7) */}
                <div className="col-span-15 col-span-5 text-center space-y-1">
                  <select
                    className="w-full bg-slate-900 text-white text-xs font-bold border border-slate-800 rounded p-1"
          ...
          {finals && (
            <div className="border-t border-slate-800 pt-5 space-y-3">
              <h3 className="text-xs font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-1.5 select-none animate-bounce">
                <Trophy className="w-4 h-4 text-emerald-500" />
                <span>The Grand Final</span>
              </h3>

              <div className="bg-gradient-to-br from-emerald-950/40 to-slate-950 p-4 rounded-2xl border-2 border-emerald-500/30 space-y-3">
                <div className="flex items-center justify-between pb-2 border-b border-emerald-950/60 select-none">
                  <span className="font-extrabold text-[12px] text-emerald-400 uppercase tracking-widest">
                ...
                <div className="grid grid-cols-11 gap-1 items-center">
                  ...
                  <div className="col-span-5 text-center space-y-1">
                    ...
                    <span className="text-[9px] text-teal-400 uppercase tracking-wider font-extrabold block">
                      Semi 1 Champions
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 pt-2 select-none">
                  <button
                    ...
                    className={`py-3.5 rounded-xl text-xs font-extrabold uppercase tracking-wide border transition-all cursor-pointer ${
                      finals.result === "pairA"
